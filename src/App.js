...
import { Moviesphotos } from './Moviesphotos';
  ...
  return (
    <div className="App">
      ...
      <Toolbar>
          ...
          <Button onClick={()=>navigate("/contacts")} color="inherit">CONTACT DETAILS</Button>
          <Button onClick={()=>navigate("/movies")} color="inherit">Add MOVIES</Button>
          <Button onClick={()=>navigate("/addcolors")} color="inherit">ADD COLOR Game</Button>
          <Button onClick={()=>navigate("/moviesphoto")} color="inherit">MoviesPhotos</Button>
          </Toolbar> 
      </AppBar>
    </Box>
      {/* <ul>
    ...
    <li>
    <Link  to="/addcolors">ADD COLOR Game</Link>
    </li>
    <li>
    <Link  to="/moviesphoto">MoviesPhotos</Link>
    </li>
     ...
     <Routes>
      ...
      <Route path="/movies" element={<MoviesData moviesdata={MVlist} addmovies={setMvlist}/>} />
      <Route path="/moviesphoto" element={<Moviesphotos moviesdata={MVlist} />} />
      <Route path="/addcolors" element={ <AddColor/>} />
      <Route path="/movies/:id" element={<KKK moviesdata={MVlist} />}/>
    </Routes>
   
    </div>
  );
}
function KKK({moviesdata}) {
  const{id}=useParams();
